...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Composed",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP8Composed18FlowLayoutDelegate_")
...
- (CGFloat)heightForGlobalHeaderIn:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout SWIFT_WARN_UNUSED_RESULT;
/// Returns the height for the global header. Return 0 to hide the global header
- (CGFloat)heightForGlobalFooterIn:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8Composed21CollectionViewWrapper")
@interface CollectionViewWrapper : NSObject <FlowLayoutDelegate, UICollectionViewDataSource>
- (void)becomeActive;
- (void)resignActive;
...
/// A <code>UICollectionReusableView</code> subclass that is intended to be used as the subclass
/// for headers and footers in collection views.
/// By default this class simply overrides the class property <code>layerClass</code> to
/// always return 0 for the <code>zPosition</code>. This is to workaround an iOS bug that
/// causes headers to render over the scrollbar
SWIFT_CLASS("_TtC8Composed26DataSourceHeaderFooterView")
@interface DataSourceHeaderFooterView : UICollectionReusableView
...
SWIFT_CLASS("_TtC8Composed24DataSourceViewController")
@interface DataSourceViewController : UIViewController
...
SWIFT_CLASS("_TtC8Composed10FlowLayout")
...
SWIFT_CLASS("_TtC8Composed20FlowLayoutAttributes")
@interface FlowLayoutAttributes : UICollectionViewLayoutAttributes
